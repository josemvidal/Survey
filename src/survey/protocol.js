...
var surveyTemplate = {
    ...
    questions: [
    	...
    	id: "intendmo2",
    	text: "PE3.  (NOTE:  If participant does not use 1 to 10 response format, read the following statement:  “For this question, you should use a number from one to 10, where 1 means 'not at all' and 10 means 'extremely'), <br/><br/> Using that same scale, where 1 is 'not at all' and 10 is 'extremely', how much would you say that you intend to quit in the next month?", value: 5, minValue: 1, maxValue: 10 
    },{
    	id:"intendsix2",
    	text: "PE4.  (NOTE:  If participant does not use 1 to 10 response format, read the following statement:  “For this question, you should use a number from one to 10, where 1 means 'not at all' and 10 means 'extremely'), <br/><br/> How much would you say that you intend to quit in the next six months?", value: 5, minValue: 1, maxValue: 10
    },{
    	id:"quitassist2",
    	text: "PE5.  (NOTE:  If participant does not use 1 to 10 response format, read the following statement:  “For this question, you should use a number from one to 10, where 1 means 'not at all' and 10 means 'extremely'), <br/><br/> Using the same scale, How likely are you to get help, like medications or counselling, the next time you try to quit? ", value: 5, minValue: 1, maxValue: 10
    },{
    	id: "damage",
